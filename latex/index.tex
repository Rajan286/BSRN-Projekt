...
\begin{DoxyItemize}
\item Benutzeroberfläche (ui.\+py)
\item Netzwerk-\/\+Modul (network.\+py, peer.\+py)
\item Discovery-\/\+Dienst (discovery.\+py)
\end{DoxyItemize}
...
Die zentrale Konfigurationsdatei {\ttfamily config.\+toml} enthält folgende Parameter\+: \begin{DoxyItemize}
...
\begin{DoxyItemize}
\item common.\+py\+: Helferfunktionen, FIFO-\/\+Verwaltung, Logging, PID-\/\+Management
\item peer.\+py\+: Modelliert Peers mit Handle, IP und Port, unterstützt Vergleich/\+Hash
\item discovery.\+py\+: Discovery-\/\+Dienst (WHO, JOIN, LEAVE, KNOWUSERS)
\item network.\+py\+: Netzwerkmodul (MSG, IMG, WHOIS, TCP/\+UDP-\/\+Sockets)
\item ui.\+py\+: Kommandozeilen-\/\+UI, zeigt Nachrichten und empfängt Befehle
...
Screenshots einbinden (in {\ttfamily docs/\+Bilder})\+:    \hypertarget{index_flow}{}\doxysection{\texorpdfstring{Flussdiagramm der Hosts}{Flussdiagramm der Hosts}}\label{index_flow}
Ablauf auf zwei Hosts im selben WLAN\+:
\begin{DoxyItemize}
\item Host A\+: startet discovery.\+py, network.\+py, ui.\+py
